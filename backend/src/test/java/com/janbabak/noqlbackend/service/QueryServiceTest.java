...
class QueryServiceTest {
    ...
    void testCreateSystemQueryTest() {
        ...
        String expectedSystemQuery = """
                ...
                it into an SQL query for the postgresdatabase. Generate this query nicely formatted with line breaks. I will use this query for
                displaying the data in form of table. If the user wants to plot, chart or visualize the data,
                create a Python script that will select the data and visualise them in a chart. Save the
                generated chart into a file called ./plotService/plots/noQlGeneratedPlot.png and don't show it.
