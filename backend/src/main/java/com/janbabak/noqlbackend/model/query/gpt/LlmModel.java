...
public enum LlmModel {
    ...
    LLAMA3_1_405B("llama3.1-405b", "LLAMA 3.1 405B"),
    LLAMA3_70B("llama3.1-70b", "LLAMA 3.1 70B"),
    ...
    CLAUDE_3_5_SONNET_20241022("claude-3-5-sonnet-20241022", "Claude 3.5 sonnet"),
